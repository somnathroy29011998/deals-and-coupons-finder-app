...
import com.dealsapp.coupons_cart_mcs.exceptions.OrderRequestException;
import com.dealsapp.coupons_cart_mcs.repositories.CartItemRepository;
import com.dealsapp.coupons_cart_mcs.repositories.WishListRepository;
import com.dealsapp.coupons_cart_mcs.wrapper.Coupons;
...
public class CartItemsServiceImpl implements CartItemsService {
	...
	public String addWishlist(String coupons_id ){
    	Coupons coupon = restTemplate.getForObject("http://localhost:8083/catalogue/find/id/" + coupons_id, Coupons.class);
		WishList wishlList = new WishList(coupons_id,coupon.getCoupons_price(),coupon.getCoupons_name(),coupon.getCoupons_desc()
				);
		wishListRepository.insert( wishlList );
		//cartItemRepository.deleteById(id);
		return ("Coupon Added Successfully in WishList");	
